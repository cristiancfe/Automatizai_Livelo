#language: pt
Funcionalidade: Autenticacao - Realizar cadastro de novo usuario na plataforma de ecommerce
  ...
  Contexto: Esteja o usuario na pagina de cadastro de usuarios na plataforma de ecommerce
     * esteja na pagina de cadastro de usuario da plataforma de ecommerce
